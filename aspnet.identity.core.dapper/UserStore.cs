...
namespace Silver.AspNetCore.Identity.Dapper
{
    ...
    {
        private const string _selectUser = @"SELECT Id, AccessFailedCount, ConcurrencyStamp, Email, EmailConfirmed, LockoutEnabled, LockoutEnd, NormalizedEmail, NormalizedUserName, PasswordHash, PhoneNumber, PhoneNumberConfirmed, SecurityStamp, " +
                " TwoFactorEnabled, UserName FROM AspNetUsers ";
        /// <summary>
        /// Creates a new instance of <see cref="UserStore"/>.
        /// </summary>
        /// <param name="context">The context used to access the store.</param>
        ...
        */
        ...
        public async virtual Task<IdentityResult> CreateAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            await Context.Connection.ExecuteAsync(@"INSERT INTO AspNetUsers (Id, AccessFailedCount, ConcurrencyStamp, Email, EmailConfirmed, LockoutEnabled, LockoutEnd, NormalizedEmail, NormalizedUserName, PasswordHash, PhoneNumber, PhoneNumberConfirmed, SecurityStamp, TwoFactorEnabled, UserName) VALUES " +
                "(@Id, @AccessFailedCount, @ConcurrencyStamp, @Email, @EmailConfirmed, @LockoutEnabled, @LockoutEnd, @NormalizedEmail, @NormalizedUserName, @PasswordHash, @PhoneNumber, @PhoneNumberConfirmed, @SecurityStamp, @TwoFactorEnabled, @UserName);", new
                {
                    Id = user.Id,
        ...
        public async virtual Task<IdentityResult> UpdateAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            await Context.Connection.ExecuteAsync(@"UPDATE AspNetUsers SET Id=@Id, AccessFailedCount = @AccessFailedCount, ConcurrencyStamp = @ConcurrencyStamp, Email = @Email, EmailConfirmed = @EmailConfirmed, LockoutEnabled = @LockoutEnabled, "+
                "LockoutEnd = @LockoutEnd, NormalizedEmail = @NormalizedEmail, NormalizedUserName = @NormalizedUserName, PasswordHash = @PasswordHash, PhoneNumber = @PhoneNumber, PhoneNumberConfirmed = @PhoneNumberConfirmed, SecurityStamp=@SecurityStamp, TwoFactorEnabled=@TwoFactorEnabled, UserName=@UserName;", new
                {
                    Id = user.Id,
                    AccessFailedCount = user.AccessFailedCount,
                    ConcurrencyStamp = user.ConcurrencyStamp,
        ...
        public async virtual Task<IdentityResult> DeleteAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            await Context.Connection.ExecuteAsync(@"DELETE FROM AspNetUsers WHERE Id=@Id;", new { id = user.Id });
            return IdentityResult.Success;
        }
        ...
        public virtual Task<TUser> FindByIdAsync(string userId, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return Context.Connection.QuerySingleAsync<TUser>(_selectUser + " WHERE Id = @Id;", new
                {
                    Id = userId
                });
        }
        ...
        */
        ...
        public virtual Task<TUser> FindByNameAsync(string normalizedUserName, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            return Context.Connection.QueryFirstOrDefaultAsync<TUser>(_selectUser + " WHERE NormalizedUserName = @NormalizedUserName;", new
                {
        ...
        */
        ...
        public async virtual Task AddToRoleAsync(TUser user, string normalizedRoleName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                throw new ArgumentException("Role name cannot be empty or null", nameof(normalizedRoleName));
            }

            var count = await Context.Connection.ExecuteAsync(@"INSERT INTO AspNetUserRoles (RoleId, UserId) " +
                "SELECT @UserId as UserId, Id as RoleId FROM AspNetRoles WHERE NormalizedName = @NormalizedName", new
                {
                    UserId = user.Id,
            ...
            if (count == 0)
            {
                throw new InvalidOperationException("Unable to find roll: "+ normalizedRoleName);
            }
        }
        ...
        public async virtual Task RemoveFromRoleAsync(TUser user, string normalizedRoleName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (string.IsNullOrWhiteSpace(normalizedRoleName))
            {
                throw new ArgumentException("RollName cannot be empty", nameof(normalizedRoleName));
            }

            await Context.Connection.ExecuteAsync(@"DELETE FROM AspNetUserRoles WHERE UserId=@UserId AND RoleId = (Select Id FROM AspNetRoles WHERE NormalizedName = @NormalizedName)", new
            {
                UserId = user.Id,
                NomralizedName = normalizedRoleName
            });
        }
        ...
        public virtual async Task<IList<string>> GetRolesAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return new List<string>(await Context.Connection.QueryAsync<string>(@"SELECT Name FROM AspNetUserRoles ur "+
                "JOIN AspNetRoles r on ur.RoleId = r.Id Where UserId=@UserId;", new { UserId = user.Id }));
        }
        ...
        public virtual async Task<bool> IsInRoleAsync(TUser user, string normalizedRoleName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (string.IsNullOrWhiteSpace(normalizedRoleName))
            {
                throw new ArgumentException("NormalizedRoleName cannot be null or empty", nameof(normalizedRoleName));
            }
            int roleCount = await Context.Connection.ExecuteScalarAsync<int>(@"SELECT Count(*) FROM AspNetUserRoles ur JOIN AspNetRoles r ON ur.RoleId = r.Id Where r.NormalizedName = @NormalizedName and ur.UserId = @UserId;",
                new { NormalizedName = normalizedRoleName, UserId = user.Id });
            return roleCount > 0;
        }
        ...
        public async virtual Task<IList<Claim>> GetClaimsAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return new List<Claim>(await Context.Connection.QueryAsync<Claim>(@"Select Id, ClaimType, ClaimValue, UserId from AspNetUserClaims WHERE UserId=@UserId;", new { UserId = user.Id }));
        }
        ...
        public virtual Task AddClaimsAsync(TUser user, IEnumerable<Claim> claims, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                Context.Connection.Execute(@"INSERT INTO AspNetUserClaims (Id, ClaimType, ClaimValue, UserId) VALUES (@Id, @ClaimType, @ClaimValue, @UserId);",
                    new { Id = new Guid(), ClaimType = claim.Type, ClaimValue = claim.Value, UserId = user.Id });
            }
        ...
        public async virtual Task ReplaceClaimAsync(TUser user, Claim claim, Claim newClaim, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            await Context.Connection.ExecuteAsync(@"UPDATE AspNetUserClaims SET ClaimType = @NewClaimType, ClaimValue = @NewClaimValue WHERE UserId = @UserId and ClaimType = @OldClaimType and ClaimValue = @OldClaimValue",
                new { NewClaimType = newClaim.Type, NewClaimValue = newClaim.Value, UserId = user.Id, OldClaimType = claim.Type, OldClaimValue = claim.Value });
        }
        ...
        public async virtual Task RemoveClaimsAsync(TUser user, IEnumerable<Claim> claims, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            foreach (var claim in claims)
            {
                await Context.Connection.ExecuteAsync(@"DELETE FROM AspNetUserClaims WHERE UserId = @UserId and ClaimType = @ClaimType and ClaimValue = @ClaimValue",
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            Context.Connection.ExecuteAsync(@"INSERT INTO AspNetUserLogins (LoginProvider, ProviderKey, ProviderDisplayName, UserId) VALUES (@LoginProvider, @ProviderKey, @ProviderDisplayName, @UserId);",
                new { LoginProvider = login.LoginProvider, ProviderKey = login.ProviderKey, ProviderDisplayName = login.ProviderDisplayName, UserId = user.Id });
            return Task.FromResult(false);
        }
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            await Context.Connection.ExecuteAsync(@"DELETE FROM AspNetUserLogins WHERE UserId=@UserId AND LoginProvider=@LoginProvider AND ProviderKey=@ProviderKey;",
                new { LoginProvider = loginProvider, ProviderKey = providerKey, UserId = user.Id });
        }
        ...
        public async virtual Task<IList<UserLoginInfo>> GetLoginsAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return new List<UserLoginInfo>(await Context.Connection.QueryAsync<UserLoginInfo>(@"SELECT LoginProvider, ProviderKey, ProviderDisplayName FROM AspNetUserLogins WHERE UserId=@UserId",
                new { UserId = user.Id }));
        }
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            //Not sure about using u.*, but it does save a lot of chars.  ALso need to make sure that it return a NULL if no records are found.
            return await Context.Connection.QueryFirstAsync<TUser>(@"SELECT u.* FROM AspNetUsers u JOIN AspNetUserLogins ul on ul.UserId=u.Id WHERE ul.LoginProvider=@LoginProvider AND ul.ProviderKey=@ProviderKey;",
        ...
        public virtual Task<TUser> FindByEmailAsync(string normalizedEmail, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            return Context.Connection.QueryFirstOrDefaultAsync<TUser>(_selectUser + "WHERE NormalizedEmail=@NormalizedEmail;", new
            {
        ...
        public async virtual Task<IList<TUser>> GetUsersForClaimAsync(Claim claim, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return new List<TUser>(await Context.Connection.QueryAsync<TUser>(@"SELECT u.* FROM AspNetUsers u JOIN AspNetUserClaims uc on uc.UserId=u.Id WHERE uc.ClaimType=@ClaimType AND uc.ClaimValue;",
        ...
        public async virtual Task<IList<TUser>> GetUsersInRoleAsync(string normalizedRoleName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return new List<TUser>(await Context.Connection.QueryAsync<TUser>(@"SELECT u.* FROM AspNetUsers u JOIN AspNetUserRoles ur on ur.UserId=u.Id JOIN AspNetRoles r ON ur.RoleId=r.Id WHERE r.NormalizedName=@NormalizedName;",
        ...
        private Task<TUserToken> FindToken(TUser user, string loginProvider, string name, CancellationToken cancellationToken)
            => Context.Connection.QueryFirstAsync<TUserToken>(@"SELECT UserId, LoginProvider, Name, Value FROM AspNetUserTokens WHERE UserId=@UserId AND LoginProvider=@LoginProvider AND Name=@Name;",
        ...
        public virtual async Task SetTokenAsync(TUser user, string loginProvider, string name, string value, CancellationToken cancellationToken)
        {
            ...
            //Postgres 9.5+ upsert.  
            await Context.Connection.ExecuteAsync(@"INSERT INTO AspNetUserTokens (UserId, LoginProvider, Name, Value) VALUES " +
                "(@UserId, @LoginProvider, @Name, @Value) on conflict (UserId, LoginProvider, Name) do " +
                "UPDATE SET (Value) = (@Value) WHERE AspNetUserTokens.UserId = @UserId AND AspNetUserTokens.LoginProvider = @LoginProvider AND AspNetUserTokens.Name = @Name;",
        ...
        public async virtual Task RemoveTokenAsync(TUser user, string loginProvider, string name, CancellationToken cancellationToken)
        {
            ...
            await Context.Connection.ExecuteAsync(@"DELETE FROM AspNetUserTokens WHERE UserId=@UserId AND LoginProvider=@LoginProvider AND Name=@Name;",
                new { UserId = user.Id, LoginProvider = loginProvider, Name = name });
        }
    ...
    //-------------------------------OLD-----------------------------
    /*
    public class UserStore<TUser, TKey, TUserLogin, TUserRole, TUserClaim>
        ...
        where TUserClaim : IdentityUserClaim<TKey>
    {
        ...
        public UserStore(DbContext database)
        {
            db = database;
        }
        ...
        {
            return db.Connection.ExecuteScalar<string>("Select Name from Member where Id=@userId", new { userId = userId });
        }
        ...
        {
            return db.Connection.Query<TUser>("Select * from Member where Id=@userId", new { userId = userId })
                .FirstOrDefault();
        }
        ...
        {
            return db.Connection.ExecuteScalar<string>("Select PasswordHash from Member where Id = @userId", new { userId = userId });
        }
        ...
        /// <returns></returns>
        public void SetPasswordHash(TKey userId, string passwordHash)
        {
        ...
        {
            return db.Connection.ExecuteScalar<string>("Select SecurityStamp from Member where Id = @userId", new { userId = userId });
        }
        ...
        {
            var id = db.Connection.ExecuteScalar<TKey>(@"Insert into Member
        ...
        /// <param name="memberId">The Member's id</param>
        /// <returns></returns>
        private void Delete(TKey userId)
        {
            db.Connection.Execute(@"Delete from Member where Id = @userId", new { userId = userId });
        }
