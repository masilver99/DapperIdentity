...
namespace Silver.AspNetCore.Identity.Dapper
{
    ...
    {
        /// <summary>
        /// Constructs a new instance of <see cref="Silver.AspNetCore.Identity.Dapper.RoleStore{TRole}"/>.
        /// </summary>
...
/*        /// <summary>Saves the current store.</summary>
        ...
        */
        ...
        public async virtual Task<IdentityResult> CreateAsync(TRole role, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            await Context.Connection.ExecuteAsync(@"Insert into AspNetRoles (Name) values (@name);",
                new { name = role.Name });
        ...
        public async virtual Task<IdentityResult> UpdateAsync(TRole role, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            await Context.Connection.ExecuteAsync(@"UPDATE AspNetRoles SET Name = @name WHERE Id = @id;",
        ...
        public async virtual Task<IdentityResult> DeleteAsync(TRole role, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            await Context.Connection.ExecuteAsync(@"Delete from AspNetRoles where Id = @id;", new {id = role.Id});
            return IdentityResult.Success;
        }
        ...
        public virtual Task<TRole> FindByIdAsync(string id, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            return Context.Connection.QueryFirstOrDefaultAsync<TRole>(@"Select Name, Id from AspNetRoles where Id = @id", new { id = id });
        }
        ...
        public virtual Task<TRole> FindByNameAsync(string name, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            return Context.Connection.QueryFirstOrDefaultAsync<TRole>(@"Select Id, ConcurrencyStamp, NormalizedName, Name from AspNetRoles where Name=@name;", new { name });
        }
        ...
        public async virtual Task<IList<Claim>> GetClaimsAsync(TRole role, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return new List<Claim>(await Context.Connection.QueryAsync<Claim>(@"SELECT Id, ClaimType, ClaimValue, RoleId FROM AspNetRoleClaims WHERE RoleId=@rollId", new { rollId = role.Id }));
        }
        ...
        public virtual Task AddClaimAsync(TRole role, Claim claim, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            Context.Connection.ExecuteAsync(@"INSERT INTO AspNetRoleClaims (Id, ClaimType, ClaimValue, RoleId) VALUES (@Id, @ClaimType, @ClaimValue, @RoleId;",new {
                Id= new Guid(), ClaimType = claim.Type, ClaimValue= claim.Value, RoleId = role.Id});
        ...
        public async virtual Task RemoveClaimAsync(TRole role, Claim claim, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            await Context.Connection.ExecuteAsync(@"DELETE FROM AspNetRoleClaims WHERE ClaimValue = @ClaimValue AND RoleId = @RoleId AND ClaimType=@ClaimType;",
                new {ClaimValue = claim.Value, ClaimType = claim.Type, RoleId = role.Id});
        }
